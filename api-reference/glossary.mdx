---
title: "Glossary"
description: "Technical terms used in TMDB API"
---

This section contains a list of technical terms you'll come across while using TMDB API and their meaning.
...
\| Credits | This refers to the list of people's roles in the movie. |
...
\| release\_date | This refers to the date a movie or TV show will be publicly available for viewing. |
